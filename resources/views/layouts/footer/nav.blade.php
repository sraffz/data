    ...
    <div class="container @auth-fluid @endauth">
        <nav>
            ...
            <p class="copyright text-center">
                ...
                <a href="https://www.kelantan.gov.my/index.php/suk-kelantan/bahagian-unit/bahagian-pengurusan-sumber-manusia" target="blank">{{ __('Bahagian Pengurusan Sumber Manusia') }}</a>
            </p>
        </nav>
    </div>
</footer>